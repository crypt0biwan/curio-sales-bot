...
const postToWebhook = async ({qty, card, totalPrice, buyer, seller, ethPrice, token, platform }) => {
	let msg = await formatMessage({ qty, card, totalPrice, buyer, seller, ethPrice, token, platform })
